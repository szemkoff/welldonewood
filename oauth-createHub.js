...
// Path to the token file (will be created after authentication)
 ...
 */
async function createSocialMediaHub(auth) {
  try {
...
async function main() {
  try {
    ...
    // Create the social media hub
    await createSocialMediaHub(auth);
